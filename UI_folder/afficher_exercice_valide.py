...
################################################################################
## Form generated from reading UI file 'afficher_exercice_valide.ui'
##
...
class Ui_AvailableExercisesDialog(object):
    def setupUi(self, AvailableExercisesDialog):
        if not AvailableExercisesDialog.objectName():
            AvailableExercisesDialog.setObjectName(u"AvailableExercisesDialog")
        AvailableExercisesDialog.resize(400, 550)
        AvailableExercisesDialog.setModal(True)
        self.mainLayout = QVBoxLayout(AvailableExercisesDialog)
        self.mainLayout.setSpacing(15)
        self.mainLayout.setObjectName(u"mainLayout")
        self.mainLayout.setContentsMargins(15, 15, 15, 15)
        self.headerLabel = QLabel(AvailableExercisesDialog)
        ...
        self.exerciseListFrame = QFrame(AvailableExercisesDialog)
        ...
        self.buttonBox = QDialogButtonBox(AvailableExercisesDialog)
        ...
        self.retranslateUi(AvailableExercisesDialog)
        self.buttonBox.accepted.connect(AvailableExercisesDialog.accept)
        self.buttonBox.rejected.connect(AvailableExercisesDialog.reject)

        QMetaObject.connectSlotsByName(AvailableExercisesDialog)
    # setupUi

    def retranslateUi(self, AvailableExercisesDialog):
        AvailableExercisesDialog.setWindowTitle(QCoreApplication.translate("AvailableExercisesDialog", u"Available Exercises", None))
        AvailableExercisesDialog.setStyleSheet(QCoreApplication.translate("AvailableExercisesDialog", u"/* === Global Styles === */\n"
