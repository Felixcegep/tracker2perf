...
class Ui_dashboard(object):
    def setupUi(self, dashboard):
        ...
        self.scrollAreaWidgetContents_days.setGeometry(QRect(0, 0, 178, 600))
        ...
        self.daysListWidget = QListWidget(self.scrollAreaWidgetContents_days)
        self.daysListWidget.setObjectName(u"daysListWidget")
        sizePolicy2 = QSizePolicy(QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Expanding)
        sizePolicy2.setHorizontalStretch(0)
        sizePolicy2.setVerticalStretch(0)
        sizePolicy2.setHeightForWidth(self.daysListWidget.sizePolicy().hasHeightForWidth())
        self.daysListWidget.setSizePolicy(sizePolicy2)

        self.verticalLayout_scroll_content.addWidget(self.daysListWidget)
    ...
    def retranslateUi(self, dashboard):
        ...
        self.welcomeLabel.setText(QCoreApplication.translate("dashboard", u"bienvenue USER", None))
        ...
        self.daysListWidget.setToolTip(QCoreApplication.translate("dashboard", u"Liste des jours", None))
